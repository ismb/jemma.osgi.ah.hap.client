...
public class SHContainers {
	...
	// public static final String attrId_ah_eh_esp_deliveredEnergySum =
	// "ah.eh.esp.deliveredEnergySum";
	public static final String attrId_ah_sh_meter_deliveredEnergySum = "ah.sh.meter.deliveredEnergySum";

	// public static final String attrId_ah_eh_esp_receivedEnergySum =
	// "ah.eh.esp.receivedEnergySum";
	public static final String attrId_ah_sh_meter_receivedEnergySum = "ah.sh.meter.receivedEnergySum";

	// public static final String attrId_ah_eh_esp_deliveredPower =
	// "ah.eh.esp.deliveredPower";
	public static final String attrId_ah_sh_meter_deliveredPower = "ah.sh.meter.deliveredPower";

	// public static final String attrId_ah_eh_esp_receivedPower =
	// "ah.eh.esp.receivedPower";
	public static final String attrId_ah_sh_meter_receivedPower = "ah.sh.meter.receivedPower";

	// public static final String attrId_ah_eh_esp_onOffStatus =
	// "ah.eh.esp.onOffStatus";
	// public static final String attrId_ah_aal_onoffstatus =
	// "ah.aal.onoffstatus";
	...
	// public static final String attrId_ah_aal_doorstatus =
	// "ah.aal.doorstatus";
	public static final String attrId_ah_sh_iascontact_open = "ah.sh.iascontact.open";

	// public static final String attrId_ah_aal_tempstatus =
	// "ah.gas.temperaturevalue";
	...
	// public static final String attrId_ah_aal_batteryvoltage =
	// "ah.aal.batteryvoltage";
	public static final String attrId_ah_sh_power_batteryvoltage = "ah.sh.power.batteryvoltage";

	// public static final String attrId_ah_aal_waterstatus =
	// "ah.aal.waterstatus";
	public static final String attrId_ah_sh_iaswater_leak = "ah.sh.iaswater.leak";

	// public static final String attrId_ah_aal_illumstatus =
	// "ah.aal.illuminance";
