...
public interface IM2MHapService {
	...
	public ContentInstanceItemsList getContentInstanceItemsList(AHContainerAddress containerAddress, long instanceId) throws M2MHapException;

	public ContentInstanceItems getContentInstanceItems(AHContainerAddress containerAddress, long startInstanceId, long endInstanceId) throws M2MHapException;

	public ContentInstanceItemsList getContentInstanceItemsList(AHContainerAddress containerAddressFilter, long startInstanceId, long endInstanceId) throws M2MHapException;

	public ContentInstance createContentInstanceBatch(AHContainerAddress containerAddress, long instanceId, Object content) throws M2MHapException;
	...
	public ContentInstance createContentInstanceBatch(AHContainerAddress containerAddress, ContentInstance contentInstance) throws M2MHapException;
	...
	public ContentInstance createContentInstanceQueued(AHContainerAddress containerAddress, long instanceId, Object content, boolean sync) throws M2MHapException;

	public ContentInstance createContentInstanceQueued(AHContainerAddress containerAddress, ContentInstance contentInstance, boolean sync) throws M2MHapException;
