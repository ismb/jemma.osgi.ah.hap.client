...
public class EHContainers {
	...
	// Min and max power are instantaneous demand values filtered by Energy@home
	// application
	...
	// Energy consumption containers (house consumptions are associated to
	// exchange smart info device)
	...
	// Delivered energy cost power info (equivalent to consumptions for all
	// plugs and smartinfo in case of no micro generation plants)
